...
HTML::LandingPages::Records - The great new HTML::LandingPages::Records!
...
Perhaps a little code snippet.
    ...
    use HTML::LandingPages::Records;

    my $foo = HTML::LandingPages::Records->new();
    ...
...
You can find documentation for this module with the perldoc command.
    ...
    perldoc HTML::LandingPages::Records
...
1; # End of HTML::LandingPages::Records
