...
HTML::LandingPages::HtmlForm - The great new HTML::LandingPages::HtmlForm!
...
Perhaps a little code snippet.
    ...
    use HTML::LandingPages::HtmlForm;

    my $foo = HTML::LandingPages::HtmlForm->new();
    ...
...
You can find documentation for this module with the perldoc command.
    ...
    perldoc HTML::LandingPages::HtmlForm
...
1; # End of HTML::LandingPages::HtmlForm
