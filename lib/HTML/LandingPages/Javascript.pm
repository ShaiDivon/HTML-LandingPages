...
HTML::LandingPages::Javascript - The great new HTML::LandingPages::Javascript!
...
Perhaps a little code snippet.
    ...
    my $foo = HTML::LandingPages::Javascript->new();
    ...
...
You can find documentation for this module with the perldoc command.
    ...
    perldoc HTML::LandingPages::Javascript
...
1; # End of HTML::LandingPages::Javascript
